...
<head>
	...
	<title>Daniel Commerace</title>	
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/DD.png">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+98) 913 041 3100</a>
								</li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset('assets/images/Daniel.png') }}" alt="mercado"></a>
						</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Tehran</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+98) 913 041 3100 - (+98) 913 343 6682</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">dkhozaie@gmail.com</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+98) 913 041 3100 - (+98) 913 343 4441</b>
									</div>
								</div>
							</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											<li><a href="https://twitter.com/?lang=en" class="link-to-item" title="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
											<li><a href="https://www.linkedin.com/in/daniel-khozaie-214196210/" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
											...
											<li><a href="https://github.com/THEDANIIEL" class="link-to-item" title="vimeo"><i class="fa fa-vimeo" aria-hidden="true"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
