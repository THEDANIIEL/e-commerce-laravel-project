                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateSlide">
                            <div class="form-group">
                                <label class="coml-md-4 control-label">Title</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="coml-md-4 control-label">Subtitle</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="coml-md-4 control-label">Price</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="coml-md-4 control-label">Link</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="coml-md-4 control-label">Image</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="coml-md-4 control-label">Status</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="coml-md-4 control-label"></label>
                                <div class="col-md-4">
